...
public class ReviewCard2 extends AppCompatActivity {
    TextView textView;
    TextView tv_quest;
    EditText et_answer;
    TextView tv_answer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String[]> data = dbHelper.getDataFromDatabaseByTime(topicId);// 데이터베이스에서 데이터 가져오기
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tv_answer.getText().toString().isEmpty()) {
                    Toast.makeText(ReviewCard2.this, "카드를 생성하세요", Toast.LENGTH_SHORT).show();
                    btn_next.setEnabled(false);
                    return;
                }
                if (et_answer.getText().toString().isEmpty()) {
                    Toast.makeText(ReviewCard2.this, "답을 입력하세요", Toast.LENGTH_SHORT).show();
                    btn_next.setEnabled(false);
                    return;
                }
                ...
                if (isFrontSide) {
                    ...
                    if (userAnswer.equals(correctAnswer)) {
                        Toast.makeText(ReviewCard2.this, "맞혔습니다!", Toast.LENGTH_SHORT).show();
                        dbHelper.insertQuiz(topicId, cardId, userAnswer, 1);
                    } else {
                        Toast.makeText(ReviewCard2.this, "틀렸습니다!", Toast.LENGTH_SHORT).show();
                        dbHelper.insertQuiz(topicId, cardId, userAnswer, 0);
                    }
                }
                if (currentIndex == data.size() - 1) {
                    Toast.makeText(ReviewCard2.this, "문제를 다 풀었습니다", Toast.LENGTH_SHORT).show();
                    btn_next.setEnabled(false);
                }
            }
        });
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReviewCard2.this, Review.class);
